...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('moviles', function (Blueprint $table) {
            ...
            $table->enum('tipo', ['kit prepago', 'kit financiado', 'wb', 'up grade', 'linea nueva', 'reposicion', 'portabilidad pre', 'portabilidad pos', 'venta de tecnologia', 'equipo pos']);
            ...
            $table->foreign('celulares_id')->references('id')->on('celulares')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('coordinador_id')->references('id')->on('users')->onDelete('cascade')->onUpdate('cascade');
            ...
            $table->foreign('cliente_cc')->references('cc')->on('clientes')->onDelete('cascade')->onUpdate('cascade');
